    ...
    <>
                ...
                <div className="flex gap-5">
                  ...
                  >
                    <div className="inline-block border-transparent rounded-full p-[2px] bg-gradient-to-r from-[#9E91AE] to-[#450206]">
                      {profiles?.picture && (
                        <img
                          className="border-[3.38px] border-white object-cover w-[50px] h-[50px] rounded-full"
                          src={
      ...
      <main className="flex">
          ...
          <div className="flex gap-[15px]">
            ...
            <div>
              ...
              <div className="font-normal text-xs leading-4 text-[#666971]">
                {profiles.profession}, {profiles.nationality}
              </div>
            </div>
          </div>
        ...
        <div id="profile-tab" className="flex my-12 mx-[70px]">
          <div
            id="profile-tab-wrap"
            className="px-[50px] py-[46px] rounded-[30px] bg-[#DED6C6]"
          >
            <div className="mb-[50px] font-semibold text-xl leading-6">
              Profile
            </div>
            <Formik
              initialValues={{
                ...
                birthDate:
                  profiles?.birthDate &&
                  moment(profiles?.birthDate).format("YYYY-MM-DD"),
              }}
            ...
            >
              {({ handleSubmit, handleChange, handleBlur, values }) => (
                <form
                  ...
                  className="flex gap-[50px] font-normal text-sm leading-5"
                >
                  <div id="profile-list" className="flex flex-col w-[468px]">
                    <div className="w-full flex flex-col gap-[50px]">
                      <div id="name" className="flex gap-8">
                        <label htmlFor="name" className="w-[130px] py-[5px]">
                          Name
                        </label>
                      ...
                      <div id="username" className="flex gap-8">
                        ...
                        <div className="w-full h-[30px] pl-[10px] py-[3px] flex flex-1 gap-5">
                          ...
                          {editUsername && (
                            <input
                              className="bg-[#fff] rounded-[12.5px]"
                              name="username"
                              onChange={handleChange}
                              onBlur={handleBlur}
                              ...
                              type="text"
                              id="username-input"
                              placeholder={`@${profiles?.username}`.toLowerCase()}
                            />
                          )}
                      ...
                      <div id="email" className="flex gap-8">
                        <label htmlFor="email" className="w-[130px] py-[5px]">
                          Email
                        </label>
                        <div className="w-full h-[30px] pl-[10px] py-[3px] flex flex-1 gap-5">
                          <div>
                            ...
                            {editEmail && (
                              <input
                                ...
                                type="text"
                                id="email-input"
                                placeholder={`${profiles?.email}`.toLowerCase()}
                              />
                            )}
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            {editPhoneNumber && (
                              <input
                                ...
                                type="text"
                                id="phone-input"
                                placeholder={`@${profiles?.phoneNumber}`.toLowerCase()}
                              />
                            )}
                          </div>
                      ...
                      <div id="gender" className="flex gap-8">
                        <div htmlFor="gender" className="w-[130px] py-[2px]">
                          Gender
                        </div>
                            ...
                            {!editBirthDate && (
                              <span>
                                {profiles?.birthDate === null ? (
                                  ...
                                  moment(profiles?.birthDate).format(
                                    "DD / MM / YYYY"
                                  )
                                )}
                              </span>
                      ...
                      <button
                        ...
                        type="submit"
                        className="my-[50px] mt-[50px] border-none rounded-2xl px-[20px] shadow-[0px_8px_10px_#38291B] bg-yellow-700 text-orange-300 font-bold no-underline w-full h-10"
                      >
                        Save
                      </button>
                    </div>
                      ...
                      <div>
                        <div className="flex items-center justify-center">
                          <div className="inline-block border-transparent rounded-full p-[2px] bg-gradient-to-r from-[#9E91AE] to-[#450206]">
                            {!selectedPicture && (
                              <img
                                className="border-[3.38px] border-white object-cover w-[110px] h-[110px] rounded-full"
                                src={
                                  profiles?.picture?.startsWith("https")
                                    ? profiles?.picture
                            ...
                            {selectedPicture && (
                              <div className="w-full h-full relative">
                                <img
                                  ...
                                  alt={profiles?.picture}
                                />
                                <div className="absolute top-0 left-0 bg-[#A87B51] opacity-50 w-full h-full rounded-full text-white flex justify-center items-center">
                                  File Selected
                                </div>
                              </div>
                            )}
          ...
          <div className="modal-box bg-transparent shadow-none">
            <div className="flex justify-center items-center gap-2">
              <AiOutlineLoading3Quarters
                ...
                size={25}
              />
              <div className="font-extrabold text-brown-400">
                Uploading Data...
              </div>
            </div>
          </div>
