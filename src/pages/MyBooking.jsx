        ...
        <div className="flex w-[926px] h-[825px] my-12 mx-[70px]">
          <div className="flex flex-col px-[50px] pt-[46px] rounded-[30px] w-full bg-[#FFE8D3]">
            <div id="upper-title" className="flex justify-between mb-[50px]">
              <div className="font-semibold text-xl leading-6">My Booking</div>
            ...
            <div className="overflow-auto" id="event-schedule">
              {histories ? histories.map(event => {
                return (
                  <div  key={`manage-event-${event.id}`}>
                    <div className="flex gap-[25px] py-[25px] border-b-2 border-gray-800">
                      ...
                      <div>
                        <label htmlFor="event-schedule" className="font-semibold text-2xl leading-9 mb-[15px]">{event.title}</label>
                        <ul>
                          <li>{event.city}</li>
                ...
                <div className= "flex flex-col gap-2">
                  <div className= "font-semibold text-2xl leading-[54px]"> No Booked Event :&#40;</div>
                  <div className= "font-medium text-m leading-[14px]"> you have&rsquo;nt book any event yet</div>
                </div>
              }
            </div>
          </div>
